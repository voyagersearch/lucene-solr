...
public class TestStressInPlaceUpdates extends AbstractFullDistribZkTestBase {
  ...
  public void stressTest() throws Exception {
    ...
    final AtomicLong operations = new AtomicLong(25000);  // number of query operations to perform in total
          ...
          try {
            while (operations.decrementAndGet() > 0) {
              ...
              if (oper < commitPercent + deletePercent + deleteByQueryPercent) {
                ...
                verbose("deleting id",id,"val=",info.intFieldValue+","+info.longFieldValue,"version",info.version);
  ...
  private static class DocInfo {
    ...
    public String toString() {
      return "[" + version + ", " + intFieldValue + ", " + longFieldValue + "]";
    }
  }
